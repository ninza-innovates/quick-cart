...
export default function TermsAndConditions({ handleCloseBtn }) {
  return (
    <>
      <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50">
        <div className="bg-white w-11/12 md:w-3/4 lg:w-1/2 max-h-[80vh] overflow-y-auto rounded-lg p-6 shadow-lg relative">
          <h2 className="text-xl font-bold mb-4">Terms of Service</h2>
          <h3>Introduction</h3>
          <p className="text-sm text-gray-600">
            Our Terms of Service were last updated on 2/28/2025. Please read
          ...
          <p className="text-sm text-gray-600">
            ...
            singular or in plural. For the purposes of these Terms of Service:
          </p>
          <ul className="list-disc list-inside text-sm text-gray-600 mt-2">
            ...
            <li>
              ...
              or "Our" in this Agreement) refers to Quick Cart.
            </li>
            <li>
            ...
            <li>
              “<b>Feedback</b>” means feedback, innovations, or suggestions sent
            ...
            <li>
              “<b>Terms of Service</b>” (also referred to as "<b>Terms</b>")
              mean these Terms of Service that form the entire agreement between
              You and the Company regarding the use of the Service. This Terms
              of Service Agreement was generated by TermsFeed Terms of Service
              Generator.
            </li>
            <li>
            ...
            <li>
              “<b>Website</b>” refers to Quick Cart, accessible from{" "}
              <Link
                href="https://quick-cart-blond.vercel.app/."
                className="underline text-blue-500 hover:text-blue-700"
              >
                https://quick-cart-blond.vercel.app/.
              </Link>
            </li>
            <li>
          ...
          <p className="text-sm text-gray-600">
            ...
            the use of the Service. Your access to and use of the Service is
            conditioned on Your acceptance of and compliance with these Terms of
            Service. These Terms of Service apply to all visitors, users and
            ...
            disagree with any part of these Terms of Service then You may not
            access the Service. You represent that you are over the age of 18.
            The Company does not permit those under 18 to use the Service. Your
          ...
          <p className="text-sm text-gray-600">
            ...
            reliability, and appropriateness. By posting Content to the Service,
          ...
          <h3 className="text-lg font-semibold mt-4">Content Restrictions</h3>
          <p className="text-sm text-gray-600">
          ...
          <h3 className="text-lg font-semibold mt-4">Content Backups</h3>
          <p className="text-sm text-gray-600">
          ...
          <p className="text-sm text-gray-600">
            ...
            any person. You may be held accountable for damages (including costs
          ...
          <h3 className="text-lg font-semibold mt-4">Termination</h3>
          <p className="text-sm text-gray-600">
            We may terminate or suspend Your Account immediately, without prior
            notice or liability, for any reason whatsoever, including without
            limitation if You breach these Terms of Service. Upon termination,
          ...
          <p className="text-sm text-gray-600">
            ...
            corrected. Without limiting the foregoing, neither the Company nor
            any of the company's provider makes any representation or warranty
          ...
          <h3 className="text-lg font-semibold mt-4">Disputes Resolution</h3>
          <p className="text-sm text-gray-600">
